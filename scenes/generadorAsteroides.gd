...
const ASTEROID_SCENE = preload("res://scenes/meteorito.tscn")

# --- Constantes de escala definidas a nivel del script ---
@export var  DIAMETRO_REAL_TIERRA_KM = 12742.0
@export var DIAMETRO_JUEGO_PLANETA = 400.0
var escala_km_a_unidades = DIAMETRO_JUEGO_PLANETA / DIAMETRO_REAL_TIERRA_KM
...
func generar_asteroides(datos_asteroides):
	...
	for data in datos_asteroides:
		...
		# --- LÍNEA MODIFICADA ---
		# Remapeamos la distancia real al nuevo rango de 500 a 1000.
		var distancia_juego = remap(distancia_real_km, min_distancia_real, max_distancia_real, 1000.0, 2000.0)
