...
/** @type {string} */
const CACHE_VERSION = '1759278359|52956470030';
/** @type {string} */
const CACHE_PREFIX = 'Comet Impact-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Comet Impact.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Comet Impact.html","Comet Impact.js","Comet Impact.offline.html","Comet Impact.icon.png","Comet Impact.apple-touch-icon.png","Comet Impact.audio.worklet.js","Comet Impact.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Comet Impact.wasm","Comet Impact.pck"];
